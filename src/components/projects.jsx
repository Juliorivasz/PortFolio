        ...
        <section className="container__section projects" id="projects">
            ...
            <div className="list__projects">
                <div className="container__card" id="encryptor">
                    ...
                    <a className="link" href="https://juliorivasz.github.io/Encriptador/" target='_blank' rel="noreferrer" title="watch project">
                        <div className="container__img">
                            <img className="img__projects" src={encryptor} alt="encryptor" />
                        </div>
                    </a>
                    <div className="container__link">
                        <a className="link" href="https://juliorivasz.github.io/Encriptador/" target='_blank' rel="noreferrer"><img className="link__img" src={demo} alt="demo"/><p>Watch</p></a>
                        <a className="link" href="https://github.com/Juliorivasz/Encriptador" target='_blank' rel="noreferrer"><img className="link__img" src={logogithub} alt="github" /><p>GitHub</p></a>
                    </div>
                </div>
                ...
                <div className="container__card" id="calculator">
                    ...
                    <a className="link" href="https://juliorivasz.github.io/calculator/" target='_blank' rel="noreferrer" title="watch project">
                        <div className="container__img">
                            <img className="img__projects" src={calculator} alt="calculator" />
                        </div>
                    </a>
                    <div className="container__link">
                        <a className="link" href="https://juliorivasz.github.io/calculator/" target='_blank' rel="noreferrer"><img className="link__img" src={demo} alt="demo" /><p>Watch</p></a>
                        <a className="link" href="https://github.com/Juliorivasz/calculator" target='_blank' rel="noreferrer"><img className="link__img" src={logogithub} alt="github" /><p>GitHub</p></a>
                    </div>
                </div>
                ...
                <div className="container__card" id="click-counter">
                    ...
                    <a className="link" href="https://juliorivasz.github.io/Click-Counter/" target='_blank' rel="noreferrer" title="watch project">
                        <div className="container__img">
                            <img className="img__projects" src={clickCounter} alt="click counter" />
                        </div>
                    </a>
                    <div className="container__link">
                        <a className="link" href="https://juliorivasz.github.io/Click-Counter/" target='_blank' rel="noreferrer"><img className="link__img" src={demo} alt="demo" /><p>Watch</p></a>
                        <a className="link" href="https://github.com/Juliorivasz/Click-Counter" target='_blank' rel="noreferrer"><img className="link__img" src={logogithub} alt="github" /><p>GitHub</p></a>
                    </div>
                </div>
            </div>
        </section>
