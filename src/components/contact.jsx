...
function Contact(){
    return (
        <section className="container__section" id="contact">
            ...
            <form className="form__contact" action="https://formsubmit.co/70add80e68d1397fe0f4ecc6de9284 21" method="POST" >
                ...
                <input type="hidden" name="_next" value="https://juliorivasz.github.io/PortFolio/#contact"/>
