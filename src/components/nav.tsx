        ...
        <nav className={`mobile ${theme === 'LightTheme' ? 'gradient__bot' : 'gradient__top'}`}>
          <div className="container__nav">
            ...
            <div className="container__bar">
              ...
              <a href="https://drive.google.com/file/d/1f5ejtSfPrju0P4zRTmyFLd0hJF51Ph1q/view?usp=sharing" target='blank' download><p className={`navegation__bar cv ${theme === "LightTheme" ? "b" : "w"}`}>Download CV</p></a>
            </div>
